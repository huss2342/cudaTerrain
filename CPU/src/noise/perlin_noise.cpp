...
namespace {
    ...
    // Safe permutation lookup function
    int safePermutation(int index) {
        return permutation[index & 255];  // Ensure index is always within bounds
    }
...
float noise(float x, float y) {
    ...
    float result = lerp(v, lerp(u, grad(permutation[AA], x, y, 0),
